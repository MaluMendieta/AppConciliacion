...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO conciliador (Id_Conciliador, Nombre, Apellido, Celular, Correo, DNI, Dirección, n_reg_general,n_reg_familia) 
...
?>
    ...
    <h1>Crear Usuario de Conciliadores</h1>
    <form method="POST" action="">
        <label for="id">ID conciliador:</label>

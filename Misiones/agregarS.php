...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO solicitante (Id_Solicitante, Nombre, Apellido, Celular, Correo, DNI, Dirección) 
    ...
    if ($query_insert) {
        ...
        echo "Error al insertar el solicitante: " . $conector->error;
    }
...
?>
    ...
    <h1>Crear Usuario de Solicitante</h1>
    <form method="POST" action="">
        <label for="id">ID solicitante:</label>
